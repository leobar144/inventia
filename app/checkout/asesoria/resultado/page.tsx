...
function ResultadoContent() {
  ...
  useEffect(() => {
    ...
    // Wompi redirige antes de que llegue el webhook, así que aquí se consulta
    // en ciclo hasta que el pago deje de estar PENDING.
    const poll = async () => {
        ...
        {status === 'LOADING' || status === 'PENDING' ? (
          ...
          <>
            ...
            <p className="text-gray-600 mb-6">
              La Sala de Tareas ya está activa. Nos vemos esta semana de 3:00 a 6:00 p.m.
            </p>
...
export default function AsesoriaResultadoPage() {
  return (
